                ...
                <ul class="training-list">
                  ...
                  >
                    ...
                    <div v-if="p1Plant.isExpanded" class="training-item-content">
                      <el-col :span="12">
                        <el-form-item label="作物分类" :rules="requiredRules">
                          <el-select
                      ...
                      <el-col :span="12">
                        <el-form-item label="作物名称" :rules="requiredRules">
                          <el-select
                        ...
                        <el-form-item label="种植时间" :rules="requiredRules">
                          <el-date-picker
...
export default {
  ...
  data() {
    return {
      ...
      stepList: _.cloneDeep(constants.STEP_LIST),
      validRules: {},
  ...
  methods: {
    ...
    show({ name, code, id, area, checkId, landName, farmLandId}) {
      this.visible = true;
    ...
    async enterHandler() {
      try {
        ...
        if (valid) {
          ...
          this.updateCurrentPlant({ key: "landName", value: this.farmLandName });
          let res = await this.approveFarmEditSubmit({id: this.checkId, approveInfo: this.plant, updateInfo: this.updateInfo});
          if (res && res.code === 0) {
