        ...
        <div class="steps-content">
          ...
          >
            <div v-show="activeIndex === 0" class="step-content-item">
              <div v-if="plant.p1 && plant.p1.length > 0" class="training-list-container">
                    ...
                    <div class="training-item-content">
                      ...
                      <el-col :span="12">
                        ...
                        <el-form-item label="条数">
                          <span>{{p1Plant.p1FishCount}}</span>
                        </el-form-item>
                        <el-form-item label="养殖时间">
                    ...
                    <div class="training-item-content">
                      ...
                      <el-col :span="24">
                        <el-form-item class="img-form-item" label="检测报告">
                          <file-carousel v-if="p7Plant.fileList.length > 0" :hasDelete="false" :files="p7Plant.fileList"></file-carousel>
                        </el-form-item>
                      </el-col>
                    </div>
                  </li>
                ...
                <ul class="training-list">
                  <li v-for="(p8Plant, index) in plant.p8DisasterInfo"
                    ...
                    <div class="training-item-content">
                      ...
                      <el-col :span="24">
                        <el-form-item class="img-form-item" label="检测报告">
                          <file-carousel v-if="p8Plant.fileList.length > 0" :hasDelete="false" :files="p8Plant.fileList"></file-carousel>
                        </el-form-item>
                      </el-col>
                    </div>
                  </li>
...
export default {
  ...
  data() {
    return {
      ...
      farmLandId: '',
      year: '',
      stepList: constants.FISH_STEP_LIST,
      datePickerOptions: {
        disabledDate(date) {
  ...
  methods: {
    ...
    show({name, id, landName}, approveStatus, checkId) {
      this.visible = true;
      this.farmLandName = landName;
      this.farmLandId = id;
