<template>
  ...
  >
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button :disabled="submitDisabled" class="enter-btn btn-style-two" @click="enterHandler">确 定</el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions({
      ...
      approveTraceSubmit: 'batch/approveTraceSubmit'
    }),
    show({id, goodsId, goodsName}) {
      this.visible = true;
      this.id = id;
    ...
    async enterHandler() {
      try {
        ...
        if (valid) {
          ...
          let res = await this.approveTraceSubmit(this.id);
          console.log(res)
          if (res && res.code === 0) {
